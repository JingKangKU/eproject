...
public class CountDownView extends View {
    ...
    public CountDownView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        mRingColor = typedArray.getColor(R.styleable.CountDownView_ringColor, context.getResources().getColor(R.color.toasty_info));
        mRingWidth = typedArray.getFloat(R.styleable.CountDownView_ringWidth, 40);
        mRingProgessTextSize = typedArray.getDimensionPixelSize(R.styleable.CountDownView_progressTextSize, 40);
        mProgessTextColor = typedArray.getColor(R.styleable.CountDownView_progressTextColor, context.getResources().getColor(R.color.toasty_info));
