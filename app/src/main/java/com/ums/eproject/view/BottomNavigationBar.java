...
public class BottomNavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    //未选中icon
    private int[] normalIcon = {R.mipmap.phone, R.mipmap.phone, R.mipmap.phone, R.mipmap.phone};
    //选中时icon
    private int[] selectIcon = {R.mipmap.safety, R.mipmap.safety, R.mipmap.safety, R.mipmap.safety};
    ...
    private void init(Context context) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.layout_navigator, this);
